...
$absolutePageUrl = Seo::canonicalUrl((string) $pageUrl);
$absolutePageImage = Seo::absoluteUrl((string) $pageImage);
?>
  ...
  <div class="share-modal">
    ...
    <div class="share-modal-body">
      <div class="share-platforms">
        <a href="https://www.facebook.com/sharer/sharer.php?u=<?= urlencode($absolutePageUrl) ?>" target="_blank" class="share-platform facebook" rel="noopener noreferrer">
        ...
        <a href="https://twitter.com/intent/tweet?text=<?= urlencode($pageTitle) ?>&url=<?= urlencode($absolutePageUrl) ?>" target="_blank" class="share-platform twitter" rel="noopener noreferrer">
        ...
        <a href="https://www.linkedin.com/sharing/share-offsite/?url=<?= urlencode($absolutePageUrl) ?>" target="_blank" class="share-platform linkedin" rel="noopener noreferrer">
        ...
        <a href="https://pinterest.com/pin/create/button/?url=<?= urlencode($absolutePageUrl) ?>&media=<?= urlencode($absolutePageImage) ?>&description=<?= urlencode($pageTitle) ?>" target="_blank" class="share-platform pinterest" rel="noopener noreferrer">
        ...
        <a href="https://wa.me/?text=<?= urlencode($pageTitle . ' ' . $absolutePageUrl) ?>" target="_blank" class="share-platform whatsapp" rel="noopener noreferrer">
        ...
        <a href="https://t.me/share/url?url=<?= urlencode($absolutePageUrl) ?>&text=<?= urlencode($pageTitle) ?>" target="_blank" class="share-platform telegram" rel="noopener noreferrer">
          <svg viewBox="0 0 24 24" fill="currentColor"><path d="M22 2L2 9l9 5 5 9 13-21z"></path><path d="M11 14l5 5"></path></svg>
          <span>Telegram</span>
        </a>
        <a href="mailto:?subject=<?= urlencode($pageTitle) ?>&body=<?= urlencode($pageTitle . ' ' . $absolutePageUrl) ?>" class="share-platform email">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg>
          <span>Email</span>
        </a>
      </div>
      <div class="share-copy-link">
        <input type="text" id="shareUrlInput" value="<?= escape($absolutePageUrl) ?>" readonly>

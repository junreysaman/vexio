...
$movieShareUrl = (string) ($item['watchUrl'] ?? ($item['watch_url'] ?? ($_SERVER['REQUEST_URI'] ?? '/')));
$movieShareImage = MediaImage::ogImageFromRow($item) ?: MediaImage::srcOnly($posterMedia);
        ...
        <div class="content-pad">
          ...
          <div class="movie-info-wrap">
            ...
            <div class="movie-details">
              ...
              <div class="movie-title">Watch <?= escape($title) ?> | Full Movie</div>
              <div class="movie-meta-row">
                <span class="mmeta-tag hd">FULL MOVIE</span>
                <span class="mmeta-tag sub">HIGH QUALITY</span>
                <span class="mmeta-tag dub">FREE</span>
              ...
              <div class="movie-actions">
                ...
                <button class="btn-icon" onclick="openShareModal(<?= escape(json_encode(\App\Support\Seo::canonicalUrl($movieShareUrl), JSON_HEX_APOS | JSON_HEX_QUOT)) ?>, <?= escape(json_encode((string) $title, JSON_HEX_APOS | JSON_HEX_QUOT)) ?>, <?= escape(json_encode(\App\Support\Seo::absoluteUrl($movieShareImage ?: '/favicon.png'), JSON_HEX_APOS | JSON_HEX_QUOT)) ?>)">
          ...
          <div class="tab-panel active" id="tab-related">
            <div class="trend-grid">
              <?php foreach (array_slice(($related ?? []), 0, 10) as $relatedItem): ?>
                <?php
